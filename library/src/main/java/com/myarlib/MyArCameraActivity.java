...
public class MyArCameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.myarlib.R.layout.activity_my_ar_camera);

        fragment = (ArFragment) getSupportFragmentManager().findFragmentById(com.myarlib.R.id.sceneform_fragment);
    ...
    private void addNodeToScene(ArFragment fragment, Anchor anchor, Renderable renderable) {
        ...
        findViewById(com.myarlib.R.id.ivRemoveModel).setVisibility(View.VISIBLE);
    }
